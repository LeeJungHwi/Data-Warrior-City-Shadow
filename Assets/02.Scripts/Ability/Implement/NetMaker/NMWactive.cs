...
public class NMWactive : SyncAbilityBase
{
    ...
    {
        // 스킬 풀링
        instantAbility = AbilityPool.instance.GetObj(AbilityType.NMW);
    ...
    {
        // 스킬 반환
        AbilityPool.instance.ReturnObj(instantAbility, AbilityType.NMW);
    }
}
