...
public class NMQactive : SyncAbilityBase
{
    ...
    {
        // 스킬 풀링
        instantAbility = AbilityPool.instance.GetObj(AbilityType.NMQ);
    ...
    {
        // 스킬 반환
        AbilityPool.instance.ReturnObj(instantAbility, AbilityType.NMQ);
    }
}
