...
public class CCQactive : SyncAbilityBase
{
    ...
    {
        // 스킬 풀링
        instantAbility = AbilityPool.instance.GetObj(AbilityType.CCQ);
    ...
    {
        // 스킬 반환
        AbilityPool.instance.ReturnObj(instantAbility, AbilityType.CCQ);
    }
}
